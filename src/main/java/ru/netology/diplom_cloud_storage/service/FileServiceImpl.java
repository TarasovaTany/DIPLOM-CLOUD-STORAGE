...
import ru.netology.diplom_cloud_storage.props.FileStoreProps;
import ru.netology.diplom_cloud_storage.repository.FileRepository;
...
public class FileServiceImpl implements FileService {
    ...
    public FileServiceImpl(StorageService storageService, UserRepository userRepository, FileRepository fileRepository,
                           FileStoreProps fileStorageProps) {
